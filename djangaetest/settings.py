"""
Django settings for djangaetest project.
...
# How can we ensure that the djangaetest.checks ones are done?
...
'''
    "djangaetest.checks.check_session_csrf_enabled",
    "djangaetest.checks.check_csp_is_not_report_only"
]
...
ROOT_URLCONF = 'djangaetest.urls'

WSGI_APPLICATION = 'djangaetest.wsgi.application'
